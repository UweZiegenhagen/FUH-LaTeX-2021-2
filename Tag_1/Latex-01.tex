...
\newcommand{\person}[1]{\textsc{\textcolor{teal}{#1}}}
...
Die ganzen Blindtext-Befehle werfen wir raus. \marginpar{Sharp ist eine japa\-nische Firma} Siehe Abbildung \ref{fig:katzi} auf Seite \pageref{fig:katzi}.
...
\begin{center}
\includegraphics[width=0.8\textwidth]{Bilder/Katze2}\captionof{figure}{Meine Miezekatze}\label{fig:katzi}
\end{center}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=0.8\textwidth]{Bilder/Katze2}\caption{Meine Miezekatze}\label{fig:katzi2}
\end{center}
\end{figure}
